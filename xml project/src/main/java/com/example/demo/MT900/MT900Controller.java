...
@RestController
@RequestMapping("/MT900")
public class MT900Controller {

	private final MT900Service MT900Service;
	
	@Autowired
	public MT900Controller(final MT900Service MT900Service){
		this.MT900Service = MT900Service;
	}
	
	@GetMapping("/getMT900Xml")
	@ResponseStatus(HttpStatus.OK)
	public void getXml() {
		try {
			File file = new File("C:\\mt900.xml");
			...
			Schema schema = null;
			try {
				schema = schemaFactory.newSchema(new File("C:\\mt900.xsd"));
